...
const SongLyrics = ({ title, lyric, music }) => {
  ...
  useEffect(() => {
    console.log("Detalles del track: ", track);
    console.log("Imagen del álbum: ", imageAlbum);
  }, []);
  ...
  const styleBg = {
    ...
    zIndex: 1,
    backgroundImage: `
      linear-gradient(to right, #B353A0 0%, rgba(255, 255, 255, 0) 15%),
